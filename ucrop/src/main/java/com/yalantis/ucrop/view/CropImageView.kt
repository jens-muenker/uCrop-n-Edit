...
open class CropImageView
    ...
    constructor(
         ...
         */
        fun setMaxResultImageSizeX(
            @IntRange(from = 10) maxResultImageSizeX: Int,
        ) {
         ...
         */
        fun setMaxResultImageSizeY(
            @IntRange(from = 10) maxResultImageSizeY: Int,
        ) {
         ...
         */
        fun setImageToWrapCropBoundsAnimDuration(
            @IntRange(from = 100) imageToWrapCropBoundsAnimDuration: Long,
        ) {
        ...
        override fun onImageLaidOut() {
            ...
            if (mTransformImageListener != null) {
                ...
                mTransformImageListener.onBrightness(currentBrightness)
                mTransformImageListener.onContrast(currentContrast)
                mTransformImageListener.onSaturation(currentSaturation)
                mTransformImageListener.onSharpness(currentSharpness)
            }
        }
